...
| 3 | Quantas vezes vem comida de fora | `fora` | Alimenta o cálculo de custo |
| 4 | **Interstício: a conta** | `conta` | Mostra o valor calculado da resposta anterior. Imagem: gasto no app de entrega |
...
| 10 | Quantas pessoas | `pessoas` | Personaliza as porções no roteiro |
| 11 | Qual dia sobra | `dia` | Define o formato do roteiro no resultado |
| 12 | O que tem em casa | `casa` | Múltipla escolha. Baixa a barreira de entrada |
| 13 | **Interstício: conta de tempo** | `tempo` | 3h45 espalhadas vs 2h30 numa vez + as 12 etapas reais |
| 14 | Já tentou antes | `tentou` | Todas as opções absolvem. Prepara o "não foi você, foi a falta de sistema" |
| 15 | O que faria com o tempo | `tempoLivre` | Aspiração. Fecha o resultado |
| 16 | Carregando | | 2,3s, monta o plano |
| 17 | Resultado | | Diagnóstico + roteiro + oferta |
...
| `pessoas` | O chip de porções no roteiro |
